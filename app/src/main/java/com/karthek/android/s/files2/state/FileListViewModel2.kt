...
@HiltViewModel(assistedFactory = FileListViewModel2.Factory::class)
class FileListViewModel2 @AssistedInject constructor(
    private val savedStateHandle: SavedStateHandle,
    private val application: Application,
    private val prefs: Prefs,
    val fileType: FileType,
    @Assisted private var cwd: File,
) : ViewModel(),
    FileOpsHandler {
    ...
    @AssistedFactory
    interface Factory {
        fun create(cwd: File): FileListViewModel2
    }
